...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            logging.info("Initiating the model trainer, splitting train and test input data")
            ...
            params={
                ...
                "K-nearest Neighbour Regressor":{"n_neighbors": [3, 5, 7], "weights": ["uniform", "distance"]},
                "Gradient Boosting":{
            ...
            # Calculate and return the r2 score for the best model
